"""Detection model: composes a frozen ViT backbone with a DETR detection head.

This is pure composition — swap any backbone that exposes
(features, spatial_shape) and any head that accepts (features, spatial_shape).
"""
...
class DetectionModel(nn.Module):
    ...
    def __init__(self, backbone: FrozenVitBackbone, head: DETRHead):
        super().__init__()
